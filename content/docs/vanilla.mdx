...
```
┌─────────────────────────────────────────────┐
│  Layer 2: Default Renderer (optional)       │
│  - Subscribes to controller events          │
│  - Builds/updates DOM automatically         │
│  - Sets data attributes for styling         │
│  - Registers draggables and drop zones      │
├─────────────────────────────────────────────┤
│  Layer 1: Headless Controller               │
│  - Manages all tree state                   │
│  - Handles drag logic and collision         │
│  - Drives sensors (pointer, touch, keyboard)│
│  - Emits events (render, drag, selection)   │
├─────────────────────────────────────────────┤
│  @dnd-block-tree/core                       │
│  - Tree factory, reducers, utilities        │
