...
```typescript
import { flatToNested, type NestedBlock } from 'dnd-block-tree'
...
```typescript
import { nestedToFlat } from 'dnd-block-tree'
...
```tsx
import { flatToNested, nestedToFlat, type BaseBlock } from 'dnd-block-tree'
